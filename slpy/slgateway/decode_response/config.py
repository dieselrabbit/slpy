...
def decode_pool_config_response(buff, data):
    ...
    data['config']['controler_id'] = dict(name="Controler ID", value=controlerID)
    ...
    data['config']['min_set_point'] = dict(name="Minimum Temperature", value=[minSetPoint0, minSetPoint1])
    data['config']['max_set_point'] = dict(name="Maximum Temperature", value=[maxSetPoint0, maxSetPoint1])

    degC, offset = getSome("B", buff, offset)
    data['config']['is_celcius'] = dict(name="Is Celcius", value=degC)
    ...
    data['config']['generic_circuit_name'] = dict(name="Default Circuit Name", value=genCircuitName)
         
    circuitCount , offset = getSome("I", buff, offset)
    data['config']['circuit_count'] = dict(name="Number of Circuits", value=circuitCount)
    ...
    data['config']['color_count'] = dict(name="Number of Colors", value=colorCount)
    ...
    for i in range(colorCount):
        ...
        data['config']['colors'][i] = dict(name=colorName, value=[ rgbR, rgbG, rgbB])
